...
class GerenciadorProcessos:
    ...
    def carregar_arquivos(self):
        ...
        [lista_arquivos, lista_instrucoes] = self.leitor_arquvo.leitura_arquivo_file(arquivo_file)
        
        self.gerenciador_arquivo = GerenciadorArquivos(lista_arquivos)
        
        for processo in self.fila.lista_processo_pronto:
            processo.setar_instrucao(lista_instrucoes)
    ...
    def executar_fila_processo_pronto(self):
        ...
        while(True):
            ...
            lista_processo_0_espera = self.memoria.verificar_disponibilidade_memoria_real(self.fila)   
            lista_processo_1_espera = self.memoria.verificar_disponibilidade_memoria_usuario(self.fila, tipo_lista=1)   
            lista_processo_2_espera = self.memoria.verificar_disponibilidade_memoria_usuario(self.fila, tipo_lista=2)    
            lista_processo_3_espera = self.memoria.verificar_disponibilidade_memoria_usuario(self.fila, tipo_lista=3)   
        ...
        #    self.adicionar_processo_fila_processo_usuario()
