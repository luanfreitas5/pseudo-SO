"""
    Classe responsável por gerenciar os arquivos em disco.
...
class Arquivo:
    ...
    """
        Classe responsável pelo carregamento de dados dos arquivos.
    """
...
class GerenciadorArquivos:
    ...
    """
        Classe responsável por manipulação, criação e deleção de arquivos.
    """
    ...
    def executar_operacao(self, processo, sequencia_geral):
        ...
        """
            Método responsável por executar_operacao as instruções do processo com base na
            execucao atual e posicao da lista de instruções.
