...
class Memoria:
    ...
    def verificar_disponibilidade_memoria_real(self,fila,recurso):
        ...
        return lista_fila_espera
                ...
                # varre lista_processo_real de prioridade 2 e se for possivel alocar moduloProcessos, tira da lista_processo_real
            # e coloca na lista_processo_real de execucao de lista_processos de lista_processo_usuario_pronto 
