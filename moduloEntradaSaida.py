...
class LeitorArquivo:
    ...
    def leitura_arquivo_processos(self, arquivo_processo):
        ...
        try:
            ...
            # 
            # O modulo de gerenciador de processo tem como prinicipio que  lista de processo pronto 
            # esteja ordernado pelos propriedade prioridade e tempo
            lista_processos.sort(key=lambda processo:(processo.prioridade, processo.tempo_inicializacao), reverse=False)
            ...
            raise Exception("Arquivo %s não localizado no diretório." % arquivo_processo)
    ...
    def leitura_arquivo_file(self, arquivo_file):
        ...
        try:
            ...
            raise Exception("Arquivo %s não localizado no diretório." % arquivo_file)
...
class Impressao:
    ...
    def imprimir_log(self):
        """
            Método para imprime o log das operacões executadas.
        """
